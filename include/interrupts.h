...
/*
 * CASM Native Execution
 * Run compiled CASM code natively with SVC trapping
 */
...
/*
 * Run code natively starting at given address
 * Returns when halt is called or error occurs
 */
